...
import {
  computeAdvanceTaxInterest as computeAdvanceTaxInterestShared,
  type AdvanceTaxInstallment,
} from '../../src/utils/advanceTaxCalculations.js';

export type { AdvanceTaxInstallment };
export { computeAdvanceTaxInterestShared as computeAdvanceTaxInterest };
