/**
 * Generates src/data/chartOfAccounts.ts with full NFRS taxonomy.
 * Run: npx tsx scripts/generate-coa.ts
 */
...
const cats: CatDef[] = [
  // EQUITY
  { category: 'share_capital', displayLabel: 'Share Capital', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'share_premium', displayLabel: 'Share Premium', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'general_reserve', displayLabel: 'General Reserve', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'retained_earnings', displayLabel: 'Retained Earnings', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'capital_reserve', displayLabel: 'Capital Reserve', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'revaluation_reserve', displayLabel: 'Revaluation Reserve', statementLine: 'BS Equity', normalBalance: 'Cr',
  ...
  { category: 'borrowings_noncurrent_bank', displayLabel: 'Long-term Bank Borrowings', statementLine: 'BS NCL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'borrowings_noncurrent_related', displayLabel: 'Related Party Loan (NCL)', statementLine: 'BS NCL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'employee_benefit_noncurrent', displayLabel: 'Employee Benefit Liability (NCL)', statementLine: 'BS NCL Employee Benefits', normalBalance: 'Cr',
  ...
  { category: 'deferred_tax_liability', displayLabel: 'Deferred Tax Liability', statementLine: 'BS NCL', normalBalance: 'Cr',
  ...
  { category: 'provisions_noncurrent', displayLabel: 'Non-current Provisions', statementLine: 'BS NCL Provisions', normalBalance: 'Cr',
  ...
  // CURRENT LIABILITIES
  { category: 'trade_payables', displayLabel: 'Trade Payables', statementLine: 'BS CL Trade Payables', normalBalance: 'Cr',
  ...
  { category: 'borrowings_current_overdraft', displayLabel: 'Overdraft / Cash Credit', statementLine: 'BS CL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'borrowings_current_working', displayLabel: 'Working Capital Loan', statementLine: 'BS CL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'borrowings_current_bank', displayLabel: 'Short-term Bank Loans', statementLine: 'BS CL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'borrowings_related_current', displayLabel: 'Related Party Loan (CL)', statementLine: 'BS CL Borrowings', normalBalance: 'Cr',
  ...
  { category: 'tds_payable', displayLabel: 'TDS Payable', statementLine: 'BS CL Tax', normalBalance: 'Cr',
  ...
  { category: 'vat_payable', displayLabel: 'VAT Payable', statementLine: 'BS CL Tax', normalBalance: 'Cr',
  ...
  { category: 'income_tax_payable', displayLabel: 'Income Tax Payable', statementLine: 'BS CL Tax', normalBalance: 'Cr',
  ...
  { category: 'advance_tax', displayLabel: 'Advance Tax Paid', statementLine: 'BS CA Tax', normalBalance: 'Dr',
  ...
  { category: 'salary_payable', displayLabel: 'Salary Payable', statementLine: 'BS CL Employee', normalBalance: 'Cr',
  ...
  { category: 'bonus_payable', displayLabel: 'Staff Bonus Payable', statementLine: 'BS CL Employee', normalBalance: 'Cr',
  ...
  { category: 'pf_ssf_payable', displayLabel: 'PF / SSF / CIT Payable', statementLine: 'BS CL Employee', normalBalance: 'Cr',
  ...
  { category: 'audit_fee_payable', displayLabel: 'Audit Fee Payable', statementLine: 'BS CL', normalBalance: 'Cr',
  ...
  { category: 'dividend_payable', displayLabel: 'Dividend Payable', statementLine: 'BS CL', normalBalance: 'Cr',
  ...
  { category: 'advance_from_customers', displayLabel: 'Advance from Customers', statementLine: 'BS CL', normalBalance: 'Cr',
  ...
  { category: 'provisions_csr', displayLabel: 'CSR Provision', statementLine: 'BS CL Provisions', normalBalance: 'Cr',
  ...
  { category: 'provisions_current', displayLabel: 'Current Provisions', statementLine: 'BS CL Provisions', normalBalance: 'Cr',
  ...
  { category: 'other_current_liabilities', displayLabel: 'Other Current Liabilities', statementLine: 'BS CL Other', normalBalance: 'Cr',
  ...
  { category: 'ppe_land', displayLabel: 'Land', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_buildings', displayLabel: 'Buildings', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_vehicles', displayLabel: 'Vehicles', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_office_equipment', displayLabel: 'Office Equipment', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_computers', displayLabel: 'Computers & IT Equipment', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_furniture', displayLabel: 'Furniture', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_plant_machinery', displayLabel: 'Plant & Machinery', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_intangibles', displayLabel: 'Intangible Assets', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'ppe_cwip', displayLabel: 'Capital Work in Progress', statementLine: 'BS NCA PPE', normalBalance: 'Dr',
  ...
  { category: 'accum_depreciation', displayLabel: 'Accumulated Depreciation', statementLine: 'BS NCA PPE Contra', normalBalance: 'Cr',
  ...
  // NCA - Investments & Other
  { category: 'investment_listed_trading', displayLabel: 'Listed Share Investments', statementLine: 'BS NCA/CA Investments', normalBalance: 'Dr',
  ...
  { category: 'investment_unlisted', displayLabel: 'Unlisted Investments', statementLine: 'BS NCA Investments', normalBalance: 'Dr',
  ...
  { category: 'investment_fixed_deposit_noncurrent', displayLabel: 'Fixed Deposit (NCA)', statementLine: 'BS NCA', normalBalance: 'Dr',
  ...
  { category: 'nca_deposits', displayLabel: 'Security Deposits (NCA)', statementLine: 'BS NCA', normalBalance: 'Dr',
  ...
  { category: 'nca_loans_advances', displayLabel: 'Loans & Advances (NCA)', statementLine: 'BS NCA', normalBalance: 'Dr',
  ...
  { category: 'biological_assets', displayLabel: 'Biological Assets', statementLine: 'BS NCA', normalBalance: 'Dr',
  ...
  { category: 'provision_impairment_investments', displayLabel: 'Provision on Investments', statementLine: 'BS NCA Contra', normalBalance: 'Cr',
  ...
  { category: 'other_noncurrent_assets', displayLabel: 'Other Non-current Assets', statementLine: 'BS NCA Other', normalBalance: 'Dr',
  ...
  // CURRENT ASSETS
  { category: 'inventory_raw_materials', displayLabel: 'Raw Materials', statementLine: 'BS CA Inventory', normalBalance: 'Dr',
  ...
  { category: 'inventory_wip', displayLabel: 'Work in Progress', statementLine: 'BS CA Inventory', normalBalance: 'Dr',
  ...
  { category: 'inventory_finished_goods', displayLabel: 'Finished Goods', statementLine: 'BS CA Inventory', normalBalance: 'Dr',
  ...
  { category: 'trade_receivables', displayLabel: 'Trade Receivables', statementLine: 'BS CA Receivables', normalBalance: 'Dr',
  ...
  { category: 'provision_impairment_debtors', displayLabel: 'Provision on Debtors', statementLine: 'BS CA Contra', normalBalance: 'Cr',
  ...
  { category: 'related_party_receivable', displayLabel: 'Related Party Receivable', statementLine: 'BS CA Receivables', normalBalance: 'Dr',
  ...
  { category: 'other_receivables_advance_supplier', displayLabel: 'Advance to Suppliers', statementLine: 'BS CA Other Receivables', normalBalance: 'Dr',
  ...
  { category: 'other_receivables_prepayments', displayLabel: 'Prepayments', statementLine: 'BS CA Other Receivables', normalBalance: 'Dr',
  ...
  { category: 'other_receivables_staff_advance', displayLabel: 'Staff Advance', statementLine: 'BS CA Other Receivables', normalBalance: 'Dr',
  ...
  { category: 'other_receivables_tds', displayLabel: 'TDS Receivable', statementLine: 'BS CA Other Receivables', normalBalance: 'Dr',
  ...
  { category: 'other_receivables_loans', displayLabel: 'Loans & Advances (CA)', statementLine: 'BS CA Other Receivables', normalBalance: 'Dr',
  ...
  { category: 'bank_current_account', displayLabel: 'Bank Current/Savings', statementLine: 'BS CA Cash', normalBalance: 'Dr',
  ...
  { category: 'bank_fixed_deposit_current', displayLabel: 'Fixed Deposit (CA)', statementLine: 'BS CA Cash', normalBalance: 'Dr',
  ...
  { category: 'cash_in_hand', displayLabel: 'Cash in Hand', statementLine: 'BS CA Cash', normalBalance: 'Dr',
  ...
  { category: 'lc_bg_margin', displayLabel: 'LC/BG Margin', statementLine: 'BS CA Other', normalBalance: 'Dr',
  ...
  { category: 'other_current_assets', displayLabel: 'Other Current Assets', statementLine: 'BS CA Other', normalBalance: 'Dr',
  ...
  // INCOME
  { category: 'revenue_sales', displayLabel: 'Sales Revenue', statementLine: 'IS Revenue', normalBalance: 'Cr',
  ...
  { category: 'revenue_services', displayLabel: 'Service Revenue', statementLine: 'IS Revenue', normalBalance: 'Cr',
  ...
  { category: 'interest_income', displayLabel: 'Interest Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'dividend_income', displayLabel: 'Dividend Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'commission_income', displayLabel: 'Commission Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'rental_income', displayLabel: 'Rental Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'gain_on_disposal', displayLabel: 'Gain on Disposal', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'insurance_claim_income', displayLabel: 'Insurance Claim Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'fv_gain_listed', displayLabel: 'FV Gain on Listed Shares', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  { category: 'other_income', displayLabel: 'Other Income', statementLine: 'IS Other Income', normalBalance: 'Cr',
  ...
  // DIRECT EXPENSES
  { category: 'purchase', displayLabel: 'Purchases', statementLine: 'IS COGS', normalBalance: 'Dr',
  ...
  { category: 'wages_direct', displayLabel: 'Direct Wages', statementLine: 'IS COGS', normalBalance: 'Dr',
  ...
  { category: 'other_direct_expenses', displayLabel: 'Other Direct Expenses', statementLine: 'IS COGS', normalBalance: 'Dr',
  ...
  { category: 'materials_consumed', displayLabel: 'Materials Consumed', statementLine: 'IS COGS', normalBalance: 'Dr',
  ...
  { category: 'salary_wages_expense', displayLabel: 'Salaries & Wages', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  { category: 'allowances_expense', displayLabel: 'Allowances', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  { category: 'pf_ssf_expense', displayLabel: 'PF/SSF Expense', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  { category: 'staff_bonus_expense', displayLabel: 'Staff Bonus Expense', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  { category: 'leave_encashment_expense', displayLabel: 'Leave Encashment', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  { category: 'other_employee_expense', displayLabel: 'Other Employee Expense', statementLine: 'IS Employee Benefits', normalBalance: 'Dr',
  ...
  // FINANCE COSTS
  { category: 'interest_expense', displayLabel: 'Interest Expense', statementLine: 'IS Finance Costs', normalBalance: 'Dr',
  ...
  { category: 'bank_charges', displayLabel: 'Bank Charges', statementLine: 'IS Finance Costs', normalBalance: 'Dr',
  ...
  { category: 'depreciation_expense', displayLabel: 'Depreciation Expense', statementLine: 'IS Depreciation', normalBalance: 'Dr',
  ...
  { category: 'impairment_on_debtors', displayLabel: 'Impairment on Debtors', statementLine: 'IS Impairment', normalBalance: 'Dr',
  ...
  { category: 'impairment_on_investments', displayLabel: 'Impairment on Investments', statementLine: 'IS Impairment', normalBalance: 'Dr',
  ...
  { category: 'fv_loss_listed', displayLabel: 'FV Loss on Listed Shares', statementLine: 'IS Impairment', normalBalance: 'Dr',
  ...
  { category: 'admin_audit_fee', displayLabel: 'Audit Fee', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_advertisement', displayLabel: 'Advertisement', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_fuel', displayLabel: 'Fuel', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_rent', displayLabel: 'Rent', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_amc', displayLabel: 'AMC', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_communication', displayLabel: 'Communication', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_legal', displayLabel: 'Legal Expenses', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_consultancy', displayLabel: 'Consultancy', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_board_agm', displayLabel: 'Board/AGM Expenses', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_csr', displayLabel: 'CSR Expenses', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_insurance', displayLabel: 'Insurance', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_miscellaneous', displayLabel: 'Miscellaneous', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_printing_stationery', displayLabel: 'Printing & Stationery', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_refreshment', displayLabel: 'Refreshment', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_travelling', displayLabel: 'Travelling', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_water_electricity', displayLabel: 'Water & Electricity', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_repair_maintenance', displayLabel: 'Repair & Maintenance', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  { category: 'admin_others', displayLabel: 'Other Admin Expenses', statementLine: 'IS Admin', normalBalance: 'Dr',
  ...
  // TAX
  { category: 'income_tax_expense', displayLabel: 'Income Tax Expense', statementLine: 'IS Tax', normalBalance: 'Dr',
  ...
  // SPECIAL
  { category: 'unclassified', displayLabel: 'Unclassified', statementLine: 'N/A', normalBalance: 'Dr', isGroup: true,
...
for (const c of cats) {
  const kw = c.keywords.map((k) => `'${esc(k)}'`).join(', ');
  const sy = c.synonyms.map((k) => `'${esc(k)}'`).join(', ');
  const nr = c.nepaliRomanized.map((k) => `'${esc(k)}'`).join(', ');
  const ex = (c.exclusionKeywords ?? []).map((k) => `'${esc(k)}'`).join(', ');
  lines.push('  {');
  lines.push(`    category: '${c.category}',`);
  lines.push(`    displayLabel: '${esc(c.displayLabel)}',`);
  lines.push(`    statementLine: '${esc(c.statementLine)}',`);
  lines.push(`    normalBalance: '${c.normalBalance}',`);
  lines.push(`    isGroup: ${c.isGroup ?? false},`);
  if (c.parentCategory) lines.push(`    parentCategory: '${c.parentCategory}',`);
  lines.push(`    keywords: [${kw}],`);
  lines.push(`    synonyms: [${sy}],`);
  lines.push(`    nepaliRomanized: [${nr}],`);
  lines.push(`    exclusionKeywords: [${ex}],`);
  lines.push('  },');
}

lines.push('];');
lines.push('');
lines.push('export const NFRS_CATEGORIES: string[] = CHART_OF_ACCOUNTS.filter((e) => !e.isGroup).map((e) => e.category);');
lines.push('');
lines.push('export function getCOAEntry(category: string): COAEntry | undefined {');
lines.push('  return CHART_OF_ACCOUNTS.find((e) => e.category === category);');
lines.push('}');
lines.push('');
lines.push('// Legacy alias');
lines.push('export type ChartAccountEntry = COAEntry;');

writeFileSync('src/data/chartOfAccounts.ts', lines.join('\n'));
console.log(`Generated chartOfAccounts.ts with ${cats.length} categories`);
